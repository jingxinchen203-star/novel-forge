...
const menuItems = [
  ...
  { icon: BookOpen, label: "创作工作台", path: "/" },
  { icon: Tags, label: "题材趋势库", path: "/" },
  { icon: FileText, label: "版本档案", path: "/" },
  { icon: CalendarClock, label: "续写计划", path: "/" },
];
